You are Copilot Agent running inside VS Code. Analyze the repository via static inspection only (Explorer, Outline, and global Search). If the intended repo is not open, ask me to open/clone:
